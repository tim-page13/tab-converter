/* -----------------------------------------------------------------
   ...
   This class defines MajorTriad as a subclass of the Chord class.
   The new elements are the major third (as measured from the root)
   and the position of the major triad in the Spiral Array.
--------------------------------------------------------------------*/
package spiralArray;

public class MajorTriad extends Chord implements TriadInterface {
	...
	double[] w = par.getMajorTriadWeight();
    ...
    public MajorTriad(Parameters par) {
    ...
    public MajorTriad(String p, Parameters par) {
...
//	System.out.println("i: " + i);
    ...
    public MajorTriad(int i, Parameters par) {
